...
import { Backpack, ChevronDown, ChevronsLeft, Eye, Forward, Upload, X } from "lucide-react";
    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="flex flex-col">
        <div className="flex flex-row justify-between bg-[#0B1219] py-3 px-4 rounded-xl mb-6">
          <div className="flex flex-col">
            <h3 className="text-[#8F9DAC] font-normal leading-[130%] text-[16px] mb-1">Registration</h3>
            <p className="text-white text-[32px] leading-[130%] font-medium">
            AT09ZAC
            </p>
          </div>
          <div className="flex flex-col justify-end text-end">
            <h3 className="text-[#8F9DAC] font-normal leading-[130%] text-[16px] mb-1">Repair Cost</h3>
            <p className="text-white text-[32px] leading-[130%] font-medium">
              £5176.29
            </p>
          </div>
        ...
        <div className="flex flex-col bg-[#0B1219] py-3 px-4 rounded-xl mb-6 gap-2">
         ...
         <div className="w-full">
            <span className="text-white text-[18px] font-medium leading-[130%] mb-4 flex">EstimateFindings:</span>
            ...
            <span className="text-[#8F9DAC] font-normal text-[16px] leading-[130%]">The system has extracted and categorized data into Labour, Paint, and Parts sections.</span>
