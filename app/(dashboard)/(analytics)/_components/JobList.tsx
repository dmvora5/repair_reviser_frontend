...
import { useGetUserJobAnalyticsListQuery, usePreviousJobsQuery } from "@/redux/apis/jobsApi";
...
const JobList = ({ userId }: any) => {
    ...
    const {
        ...
        isSuccess,
        isFetching,
    } = useGetUserJobAnalyticsListQuery(userId, {
        skip: !userId
    });
