...
import { useCreateCompanyUserMutation, useUpdateCompanyUserMutation } from "@/redux/apis/userManagementApis";
...
interface UpdateUserPopupUserPopupProps {
    isOpen: boolean;
    onClose: () => void;
    editUser: any;
}

const UpdateUserPopup: React.FC<UpdateUserPopupUserPopupProps> = ({
    isOpen,
    onClose,
    editUser
}) => {
    ...
    useEffect(() => {
        ...
        form.setValue('username', editUser?.username);
    }, [editUser])
